...
public class DeadlinePanel extends JPanel {
	private final SpinnerNumberModel valuemodel = new SpinnerNumberModel(180, 1, 10000, 10);
	private JSpinner spinner = new JSpinner(valuemodel);
	private JComboBox<DeadlineType> combobox = new JComboBox<DeadlineType>(DeadlineType.values());
