...
public class TestBoaRepo {
	...
	public void smokeTest() throws JAXBException {
		...
		BoaRepository.loadRepository(new File("test/resources/boarepository.xml"));
	}

	@Test
	public void testLoad() throws JAXBException {
		BoaRepository repo = BoaRepository.loadRepository(new File("test/resources/boarepository.xml"));
