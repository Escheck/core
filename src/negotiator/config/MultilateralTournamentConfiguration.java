...
public class MultilateralTournamentConfiguration implements MultilateralTournamentConfigurationInterface {
	...
	@XmlElementRef
	private List<? extends ParticipantRepItem> partyBItems;

	@XmlElementWrapper(name = "partyBProfiles")
	@XmlElement(name = "item")
	private List<? extends ProfileRepItem> profileBItems;
	...
	public MultilateralTournamentConfiguration(MultiPartyProtocolRepItem protocol, Deadline deadline2,
			PartyRepItem mediator, List<ParticipantRepItem> parties, List<ProfileRepItem> profiles,
			List<ParticipantRepItem> partiesB, List<ProfileRepItem> profilesB, int nrepeats, int nparties,
			boolean repeatParties, boolean isRandomSessionOrder, PersistentDataType type, boolean enablePrint) {
	 ...
	 */
	public static MultilateralTournamentConfiguration load(File file) throws JAXBException {
		return MultilateralTournamentsConfiguration.load(file).getTournaments().get(0);
	}
