...
public class MultilateralAnalysis {
	 ...
	 */
	public MultilateralAnalysis(List<? extends PartyWithUtility> parties, Bid agreedBid, Double endTime) {
	...
	private Double getUtility(Bid bid, UtilitySpace us) {
		return endTime == null ? us.getUtility(bid) : us.discount(us.getUtility(bid), endTime);
	}
