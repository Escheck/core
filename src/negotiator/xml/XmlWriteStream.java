...
public class XmlWriteStream {
	 ...
	 */
	public XmlWriteStream(OutputStream out, String topLabel) throws XMLStreamException {
	...
	public void write(String name, Map<Object, Object> data) throws XMLStreamException {
		...
		for (Object key : data.keySet()) {
			if (!(data.get(key) instanceof Map<?, ?>)) {
				...
				stream.writeAttribute(key.toString(), value == null ? "null" : value.toString());
			}
		}
	...
	public void close() {
		try {
			...
			e.printStackTrace();
			// notifying caller makes not a lot of sense here,
			// he can't fix anything at this point.
		}
	}
